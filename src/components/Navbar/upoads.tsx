...
const Uploads = ({
  ...
  return (
    <div className="w-full">
      ...
      <div className="flex justify-around py-5">
        {isExpanded && (
          <button
            className={
              initial || isImages
                ? 'border-b-2 border-blue-500 p-5'
                : 'text-[#A0A5D0] border-b-2 border-gray-500 p-5'
            }
        ...
        {isExpanded && (
          <button
            className={
              isVideos
                ? 'border-b-2 border-blue-500 p-5 me-2'
                : 'text-[#A0A5D0] border-b-2 border-gray-500 p-5 me-2'
            }
      ...
      {isExpanded &&
        isImages &&
        imageUpload?.map((image: string, id: number) => {
          return (
            <div
              key={id}
